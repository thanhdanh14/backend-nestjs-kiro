...
export class UsersController {
  ...
  // ==================== TẠO USER ====================
  @Post()
  // Bất kỳ user đã login đều có thể tạo user mới
  // Nếu muốn restrict, thêm @Roles(Role.ADMIN)
  ...
  // ==================== LẤY TẤT CẢ USERS ====================
  @Get()
  // Bất kỳ user đã login đều có thể xem danh sách
  // Nếu muốn restrict, thêm @Roles(Role.ADMIN, Role.MODERATOR)
  findAll() {
  ...
  // ==================== XÓA USER ====================
  @Delete(':id')
  // Bất kỳ user đã login đều có thể xóa
  // Nếu muốn restrict, thêm @Roles(Role.ADMIN)
